...
def process_solar_energy_forecast(input_file_path: str, output_file_path: str, forecast_column: str,
...
if __name__ == "__main__":
    ...
    process_solar_energy_forecast(input_file_path, output_file_path, forecast_column, best_p, best_d, best_q, best_P, best_D, best_Q, best_S, unit)
